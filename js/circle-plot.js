...
Assembly.prototype.drawPlot = function(parent_div, longest, circle_span) {
  ...
  if (this.busco) {
    ...
    key.append('rect').attr('x', w * 1.5).attr('height', w).attr('width', w).attr('class', 'asm-busco_D asm-toggle');
    ...
    key.append('rect').attr('x', w * 4.5).attr('height', w).attr('width', w).attr('class', 'asm-busco_M asm-toggle');
